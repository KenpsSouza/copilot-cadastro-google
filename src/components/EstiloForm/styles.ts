...
export const FormContainer = styled.div`
  ...
  &::before {
    ...
    background: linear-gradient(135deg, rgba(229, 24, 45, 0.5), rgba(168, 85, 247, 0.5), rgba(59, 130, 246, 0.5), rgba(6, 182, 212, 0.5), rgba(168, 85, 247, 0.5), rgba(229, 24, 45, 0.5));
...
export const ActionButton = styled.button<{ $variant?: 'primary' | 'secondary' | 'danger' }>`
  ...
  ${({ $variant }) => {
    switch ($variant) {
      case 'primary':
        return `
          background: linear-gradient(135deg, rgb(229, 24, 45), #a855f7);
          color: white;
